...
for(const name of ['model','physics','solver','view','replay','replay-player','app','compositions/marble-cup'])module(`@kinetic/${name}`,read(`src/${name}.js`).replaceAll(/'\.\/([^']+)\.js'/g,"'@kinetic/$1'"));
